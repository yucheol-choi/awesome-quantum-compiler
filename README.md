...
> [!NOTE]
> I plan to re-examine this paper list from the beginning. Going forward, I will manage my repository anew while prioritizing only **rigorously verified with strong future citation potential** papers for research. This repository will remain eternally maintained until **the end of my career**. 
